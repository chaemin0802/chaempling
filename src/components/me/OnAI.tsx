...
export default async function OnAI() {
  ...
  const punch = isKo
    ? '근데 지금? 내가 곧 AI, AI가 곧 나야.'
    : 'and now? I am AI, AI is me.';
  ...
  const paragraphs = isKo
    ? [
        ...
        '디자이너라는 정체성을 계속 지키려 해. 본질을 지키려 해. AI가 나를 대체한 게 아니야 — AI 덕분에 내가 더 날카로워졌어.',
      ]
    : [
        ...
        "I'm protecting my designer identity. I'm protecting what's essential. AI didn't replace me — AI made me sharper.",
      ];
